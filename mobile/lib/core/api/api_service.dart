...
class ApiService {
  ...
  /// Called when token refresh fails — triggers forced logout in AuthProvider.
  ...
  Future<bool> _refreshToken() async {
    ...
    try {
      ...
      // Trigger forced logout so UI navigates to login
      onAuthExpired?.call();
    } finally {
      _isRefreshing = false;
    }
  ...
  /// Invalidate current session on the backend.
  Future<Response> logoutFromServer() async {
