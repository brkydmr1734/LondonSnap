...
// Use SendGrid HTTP API instead of SMTP (Railway blocks port 587)
...
class EmailService {
  private fromEmail = process.env.SMTP_FROM || 'noreply@londonsnaps.app';
  private fromName = process.env.SMTP_FROM_NAME || 'LondonSnaps';
